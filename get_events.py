...
#parser.add_argument('-p','--password',dest='password', action=PasswordPromptAction, type=str, required=False, help='The script will prompt for your password.')
...
# Remove empty strings in list d
d = filter(len,d)
